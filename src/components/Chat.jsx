  ...
  
{
  ...
  },
  {
    ...
    ingredients: ['Творог  -350гр', 'Куриное яйцо  -2шт', 'Пшеничная мука  -6 ст.л ', 'Сахар  -2ст.л', 'Подсолнечное масло  - 5 ст.л ',"Специи-по вкусу" ],
    imageUrl:
      'https://img.razrisyika.ru/kart/130/1200/516086-syrniki-12.jpg',
    cookingTime: '30 минут',
    description: 'Главный секрет идеальных сырников — а точнее творожников, — творог нужно протереть через мелкое сито и отжать от влаги.',
    reviews: [
      
      { author: 'Лёха:', text: 'Муки можно в два раза меньше. Даже 4 ложки уже слишком много на такое количество творога.' },
      { author: 'Alex:', text: 'good' },
      { author: 'Диназавар-911:', text: 'Спасибо!' },
    ],
    mealType:'Ужин',
  ...
  {
    name: 'Самса',
    ingredients: ['Куриное яйцо  - 1шт', 'Пшеничная мука в/с  - 1кг', 'Молочный маргарин 300гр', ' Репчатый лук  - 500г', 'Кунжут  - по вкусу','Соль  - 2.5ст.л','Черный молотый перец  - 2ч.л.','Вода  - 500мл','Куриное бедро  -1кг'],
    imageUrl:
      'https://avatars.mds.yandex.net/i?id=56ea9206dc0481a2386447366dcc29f53249580fd727a35c-4453493-images-thumbs&n=13',
    cookingTime: '45 минут',
    description: 'Самса — культурный символ Центральной Азии. Рецепт изобретен в Самарканде (Узбекистан) в XI веке. ',
    reviews: [
      { author: 'Михаил:', text: 'просто объедение! ' },
      { author: 'Ольга:', text: 'Ого' },
      { author: 'Васька:', text: 'Рахмет' },
  ...
  },
  {
    ...
    ingredients: ['Белый хлеб  - 4куска', 'Помидоры  - 3шт', 'Оливковое масло  -30 мл', ' Репчатый лук  - 500г', 'Чеснок  - 3 зубч','Бальзамический крем  - 10гр','Свежемолотый черный перец  - по вкусу','Соль  - по вкусу','Зелень  -30г'],
    imageUrl:
      'https://avatars.mds.yandex.net/i?id=961782e3ee42707118b3b575ad9dd49404ea9384-4571959-images-thumbs&n=13',
    cookingTime: '10 минут',
    description: 'Брускетта с помидорами — вкусная итальянская закуска, а также простейший способ положить что-то на зуб, почувствовать легкую сытость, но обойтись при этом без переедания.  ',
    reviews: [
      { author: 'Михаил:', text: 'просто объедение! ' },
      { author: 'Ольга:', text: 'Ого' },
      { author: 'Васька:', text: 'Рахмет' },
